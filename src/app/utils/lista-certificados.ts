...
export const certificados: Certificado[] = [
  ...
  {
    urlImagem: 'https://i.imgur.com/DveLM3s.jpeg',
    titulo: 'Desenvolvimento de APIs Web em .NET',
    tipo: 'certificado',
  },
  {
    urlImagem: 'https://i.imgur.com/aeUbp5J.jpeg',
    titulo: 'Desenvolvedor Web Fullstack na Academia do Programador 2025',
    tipo: 'certificado',
  },
];
